...
class TestCriteriaVector(unittest.TestCase):
    ...
    def testConstructor(self):
        ...
        self.assertTrue(self.criteria_vector.criteria_functions[0](-2))
    ...
    def testFunctions(self):
        ...
        self.assertTrue(self.criteria_vector.criteria_functions[0](-2))
        self.assertFalse(self.criteria_vector.criteria_functions[0](2))
        self.assertTrue(self.criteria_vector.criteria_functions[1](-1))
        self.assertFalse(self.criteria_vector.criteria_functions[1](2))
        self.assertTrue(self.criteria_vector.criteria_functions[2](0))
        self.assertFalse(self.criteria_vector.criteria_functions[2](2))
        self.assertTrue(self.criteria_vector.criteria_functions[3](1))
